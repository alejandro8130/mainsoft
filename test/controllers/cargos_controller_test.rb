...
class CargosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cargo" do
    assert_difference('Cargo.count') do
      post cargos_url, params: { cargo: { nombre: @cargo.nombre, salario_devengado: @cargo.salario_devengado } }
    end
  ...
  test "should update cargo" do
    patch cargo_url(@cargo), params: { cargo: { nombre: @cargo.nombre, salario_devengado: @cargo.salario_devengado } }
