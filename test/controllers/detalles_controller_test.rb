...
class DetallesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detalle" do
    assert_difference('Detalle.count') do
      post detalles_url, params: { detalle: { cantidad_producto: @detalle.cantidad_producto, producto_id: @detalle.producto_id, valor: @detalle.valor, venta_id: @detalle.venta_id } }
    end
  ...
  test "should update detalle" do
    patch detalle_url(@detalle), params: { detalle: { cantidad_producto: @detalle.cantidad_producto, producto_id: @detalle.producto_id, valor: @detalle.valor, venta_id: @detalle.venta_id } }
