...
class CiudadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ciudad" do
    assert_difference('Ciudad.count') do
      post ciudades_url, params: { ciudad: { departamento_id: @ciudad.departamento_id, nombre: @ciudad.nombre } }
    end
  ...
  test "should update ciudad" do
    patch ciudad_url(@ciudad), params: { ciudad: { departamento_id: @ciudad.departamento_id, nombre: @ciudad.nombre } }
