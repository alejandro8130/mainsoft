...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { cantidad: @producto.cantidad, garantia: @producto.garantia, marca: @producto.marca, nombre: @producto.nombre, precio: @producto.precio, proveedor_id: @producto.proveedor_id } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { cantidad: @producto.cantidad, garantia: @producto.garantia, marca: @producto.marca, nombre: @producto.nombre, precio: @producto.precio, proveedor_id: @producto.proveedor_id } }
