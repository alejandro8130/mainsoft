class DepartamentosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @departamento.save
        format.html { redirect_to @departamento, notice: 'El Departamento se ha creado correctamente.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to departamentos_url, notice: 'El Departamento se ha eliminado correctamente.' }
