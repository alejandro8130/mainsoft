class ProveedoresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @proveedor.save
        format.html { redirect_to @proveedor, notice: 'El Proveedor se ha creado correctamente.' }
  ...
  def update
    respond_to do |format|
      if @proveedor.update(proveedor_params)
        format.html { redirect_to @proveedor, notice: 'El Proveedor se ha actualizado correctamente.' }
  ...
  def destroy
    @proveedor.destroy
    respond_to do |format|
      format.html { redirect_to proveedores_url, notice: 'El Proveedor se ha eliminado correctamente.' }
